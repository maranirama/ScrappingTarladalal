...
public class HighBloodPressure extends BaseTest {
	...
	public static void highBloodPressure() throws InterruptedException, IOException {
		...
		xlreader.setcelldata("HyperTension", 0, 8, "morbidity");
		xlreader.setcelldata("HyperTension", 0, 9, "foodcatagory");
				...
				for (int a = 0; a <=recipeName.size(); a++) 
				{
					...
					xlreader.setcelldata("HyperTension", a+1, 8, foodCategory);
					xlreader.setcelldata("HyperTension", a+1, 9, morbidities) ;
					}
					catch(Exception e)
					{
