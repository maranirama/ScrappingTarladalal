...
public class HTAllergy extends BaseTest {
	...
	public static void highBloodPressure() throws InterruptedException, IOException {
		...
		for (int p = 1; p <= 3; p++) {
...

			{
				...
				boolean isIngrediantAllergy = CheckList.allergy(Ingrediants);
		...
		xlreader.setcelldata("HTAllergy", 0, 0, "recipeid");
		xlreader.setcelldata("HTAllergy", 0, 1, "recipename");

		xlreader.setcelldata("HTAllergy", 0, 2, "ingrediant");

		xlreader.setcelldata("HTAllergy", 0, 3, "preparation Time");
		xlreader.setcelldata("HTAllergy", 0, 4, "cook Time");

		xlreader.setcelldata("HTAllergy", 0, 5, "preparation method");
		xlreader.setcelldata("HTAllergy", 0, 6, "Nutrients");
		xlreader.setcelldata("HTAllergy", 0, 7, "url");
		xlreader.setcelldata("HTAllergy", 0, 8, "morbidity");
		xlreader.setcelldata("HTAllergy", 0, 9, "foodcatagory");
				...
				for (int a = 0; a <=recipeName.size(); a++) 
				{
					try
					{
					xlreader.setcelldata("HTAllergy", a+1, 0, recipeid.get(a));
					xlreader.setcelldata("HTAllergy", a+1, 1, recipeName.get(a));
					xlreader.setcelldata("HTAllergy", a+1, 2, ingredientList.get(a));

					xlreader.setcelldata("HTAllergy", a+1, 3, prepTime.get(a));
					xlreader.setcelldata("HTAllergy", a+1, 4, cookTime.get(a));
					xlreader.setcelldata("HTAllergy", a+1, 5, prepMethod.get(a)); 
					xlreader.setcelldata("HTAllergy", a+1, 6, NutrientList.get(a));
					xlreader.setcelldata("HTAllergy", a+1, 7, RecipeUrlList.get(a));
					xlreader.setcelldata("HTAllergy", a+1, 8, foodCategory );
					xlreader.setcelldata("HTAllergy", a+1, 9, morbidities );
					}
					catch(Exception e)
					{
