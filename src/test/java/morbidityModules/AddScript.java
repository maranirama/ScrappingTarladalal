...
public class AddScript extends BaseTest {
	...
	public static void highBloodPressure() throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath("//input[@id='ctl00_txtsearch']")).sendKeys("Water melon");
		...
		xlreader.setcelldata("HT", 0, 0, "recipeid");
		xlreader.setcelldata("HT", 0, 1, "recipename");

		xlreader.setcelldata("HT", 0, 2, "ingrediant");

		xlreader.setcelldata("HT", 0, 3, "preparation Time");
		xlreader.setcelldata("HT", 0, 4, "cook Time");

		xlreader.setcelldata("HT", 0, 5, "preparation method");
		xlreader.setcelldata("HT", 0, 6, "Nutrients");
		xlreader.setcelldata("HT", 0, 7, "url");
				...
				for (int a = 0; a <=recipeName.size(); a++) 
				{
					try
					{
					xlreader.setcelldata("HT", a+1, 0, recipeid.get(a));
					xlreader.setcelldata("HT", a+1, 1, recipeName.get(a));
					xlreader.setcelldata("HT", a+1, 2, ingredientList.get(a));

					xlreader.setcelldata("HT", a+1, 3, prepTime.get(a));
					xlreader.setcelldata("HT", a+1, 4, cookTime.get(a));
					xlreader.setcelldata("HT", a+1, 5, prepMethod.get(a)); 
					xlreader.setcelldata("HT", a+1, 6, NutrientList.get(a));
					xlreader.setcelldata("HT", a+1, 7, RecipeUrlList.get(a));
					}
					catch(Exception e)
					{
